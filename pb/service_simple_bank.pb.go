...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x16rpc_verify_email.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xa0\x04\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"?\x92A\"\x12\vUpdate User\x1a\x13API for update user\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\x98\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"X\x92A=\x12\x14Verify Email Address\x1a%Use this API for verify email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB{\x92AX\x12V\n" +
	"\x0fSimple bank API\">\n" +
