...
func (x *LoginUserResponse) GetXToken() string {
	if x != nil {
		return x.XToken
	}
	return ""
...
func (x *LoginUserResponse) GetXRefreshToken() string {
	if x != nil {
		return x.XRefreshToken
	}
	return ""
}

func (x *LoginUserResponse) GetTokenExpiredAt() *timestamppb.Timestamp {
	if x != nil {
		return x.TokenExpiredAt
	}
	return nil
}
...
const file_rpc_login_user_proto_rawDesc = "" +
	...
	"\x18refresh_token_expired_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\x15refreshTokenExpiredAtB Z\x1egithub.com/Cell6969/go_bank/pbb\x06proto3"
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 1: pb.LoginUserResponse.token_expired_at:type_name -> google.protobuf.Timestamp
