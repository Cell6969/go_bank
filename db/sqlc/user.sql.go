...
INSERT INTO users (
    ...
    $1, $2, $3, $4
) RETURNING username, password, full_name, email, password_changed_at, created_at, is_email_verified
`
...
SELECT username, password, full_name, email, password_changed_at, created_at, is_email_verified FROM users
